...
ActionTypes: Это объединение типов действий (IncrementAction и DecrementAction), которое представляет все возможные типы действий, доступные в Redux-хранилище. */}
